...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/validate.service.js.map
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/main.js.map
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/app.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_user_profile_user_profile_component__ = __webpack_require__(517);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__guards_authlogout_guard__ = __webpack_require__(519);
...
var appRoutes = [
    ...
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_9__components_register_register_component__["a" /* RegisterComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_authlogout_guard__["a" /* AuthLogoutGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_8__components_login_login_component__["a" /* LoginComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_authlogout_guard__["a" /* AuthLogoutGuard */]] },
    ...
    { path: 'users/profile', component: __WEBPACK_IMPORTED_MODULE_12__components_user_profile_user_profile_component__["a" /* UserProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] }
];
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__components_user_profile_user_profile_component__["a" /* UserProfileComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_13__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_16__guards_authlogout_guard__["a" /* AuthLogoutGuard */], __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["b" /* Title */]],
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/app.module.js.map
...
var DashboardComponent = (function () {
    function DashboardComponent(titleService) {
        this.titleService = titleService;
        this.titleService.setTitle("Portal App | Dashboard");
    }
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/dashboard.component.js.map
...
var HomeComponent = (function () {
    function HomeComponent(titleService) {
        this.titleService = titleService;
        this.titleService.setTitle("Portal App | Home");
    }
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/home.component.js.map
...
var LoginComponent = (function () {
    function LoginComponent(authService, validateService, flashMessage, router, titleService) {
        ...
        this.titleService = titleService;
        this.timeout = 2000;
        this.titleService.setTitle("Portal App | Login");
    }
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show(data.message, { cssClass: 'alert-success', timeout: _this.timeout });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessage.show(data.message, { cssClass: 'alert-danger', timeout: _this.timeout });
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/navbar.component.js.map
...
var RegisterComponent = (function () {
    function RegisterComponent(authService, validateService, flashMessage, router, titleService) {
        this.authService = authService;
        this.validateService = validateService;
        this.flashMessage = flashMessage;
        this.router = router;
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/register.component.js.map
...
var UserProfileComponent = (function () {
    function UserProfileComponent(authService, flashMessage, router, titleService) {
        this.authService = authService;
        this.flashMessage = flashMessage;
        this.router = router;
        this.titleService = titleService;
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/user-profile.component.js.map
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/auth.guard.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_auth_service__ = __webpack_require__(66);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuthLogoutGuard; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthLogoutGuard = (function () {
    function AuthLogoutGuard(authService, router) {
        this.authService = authService;
        this.router = router;
    }
    AuthLogoutGuard.prototype.canActivate = function () {
        if (!this.authService.loggedIn()) {
            return true;
        }
        else {
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/authlogout.guard.js.map
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/environment.js.map
...
//# sourceMappingURL=C:/sid/project/mean-framework2/angular-src/src/auth.service.js.map
...
module.exports = "<app-navbar></app-navbar>\n\n<div class=\"container\">\n    <flash-messages class=\"col-md-8 col-md-offset-2\"></flash-messages>\n    <router-outlet></router-outlet>\n</div>\n"
...
module.exports = "<div class=\"col-md-8 col-md-offset-2\">    \n    <h2 class=\"page-header bold\">Register</h2>\n    <form (submit)=\"onRegisterSubmit()\">\n        <div class=\"form-group\">\n            <label>Name</label>\n            <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Username</label>\n            <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Email</label>\n            <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Password</label>\n            <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\">\n        </div>\n        <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n    </form>\n</div>"
...
module.exports = "<div *ngIf=\"user\" class=\"col-md-8 col-md-offset-2\">\n    <h2 class=\"page-header bold\">{{user.name}}</h2>\n    <ul class=\"list-group\">\n        <li class=\"list-group-item\"> Username: {{user.username}}</li>\n        <li class=\"list-group-item\"> Email: {{user.email}}</li>\n    </ul>\n</div>"
